...
extension OrdersVC {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        guard let confirmOrderVC = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "PerformOrderAlertVC") as? PerformOrderAlertVC else {
            return
        }
        confirmOrderVC.orderId = driversOrder.id
        
        // presenting accessed ViewController
//        self.present(confirmOrderVC, animated: true, completion: {
