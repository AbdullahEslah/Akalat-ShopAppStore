...
class DriverOnBoardingVC: UIViewController ,UIScrollViewDelegate{
    ...
    @IBAction func orderNow(_ sender: Any) {
        ...
        let storyboard = UIStoryboard(name: "DriverRegion", bundle: nil)
        let regionVC = storyboard.instantiateViewController(withIdentifier: "DriverRegionVC") as! DriverRegionVC
