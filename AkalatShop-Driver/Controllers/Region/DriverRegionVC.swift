...
class DriverRegionVC: UIViewController {
...
//        fetchRestaurantsAdresses()
    ...
    @IBAction func nextButton(_ sender: Any) {
        ...
        let loginVC = storyboard.instantiateViewController(withIdentifier: "DriverLoginVC") as! DriverLoginVC
...
extension DriverRegionVC: UIPickerViewDelegate,UIPickerViewDataSource {
