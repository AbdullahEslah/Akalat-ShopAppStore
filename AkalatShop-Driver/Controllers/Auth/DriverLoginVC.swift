...
class DriverLoginVC: UIViewController, LoginButtonDelegate, GIDSignInDelegate, GIDSignInUIDelegate {
    ...
    override func viewDidLoad() {
        ...
        GIDSignIn.sharedInstance().clientID = "753178663409-02tf19lokpeo2an3v376t0t3soho7m4i.apps.googleusercontent.com"
    ...
    func authorizationController(controller: ASAuthorizationController, didCompleteWithAuthorization authorization: ASAuthorization) {
        ...
        case let appleIDCredential as ASAuthorizationAppleIDCredential:
            ...
            if let identityToken = appleIDCredential.identityToken {
                    ...
                    NetworkManager.Auth.appleAcccessToken = identityTokenString
